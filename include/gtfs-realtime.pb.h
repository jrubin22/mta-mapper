...
class FeedHeader PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_feed_version(const std::string& value);
  void set_feed_version(std::string&& value);
  void set_feed_version(const char* value);
  void set_feed_version(const char* value, size_t size);
  std::string* mutable_feed_version();
  std::string* release_feed_version();
  void set_allocated_feed_version(std::string* feed_version);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_feed_version();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_feed_version(
      std::string* feed_version);
  private:
  const std::string& _internal_feed_version() const;
  void _internal_set_feed_version(const std::string& value);
...
class TripDescriptor_ModifiedTripSelector PROTOBUF_FINAL :
 ...
 public:
  ...
  GOOGLE_PROTOBUF_EXTENSION_ACCESSORS(TripDescriptor_ModifiedTripSelector)
...
inline void FeedHeader::clear_feed_version() {
  feed_version_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void FeedHeader::set_feed_version(const std::string& value) {
  _internal_set_feed_version(value);
...
inline std::string* FeedHeader::mutable_feed_version() {
  ...
  return _internal_mutable_feed_version();
}
inline const std::string& FeedHeader::_internal_feed_version() const {
  return feed_version_.Get();
}
inline void FeedHeader::_internal_set_feed_version(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  feed_version_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void FeedHeader::set_feed_version(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  feed_version_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:transit_realtime.FeedHeader.feed_version)
}
inline void FeedHeader::set_feed_version(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  feed_version_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:transit_realtime.FeedHeader.feed_version)
}
inline void FeedHeader::set_feed_version(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  feed_version_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:transit_realtime.FeedHeader.feed_version)
}
inline std::string* FeedHeader::_internal_mutable_feed_version() {
  _has_bits_[0] |= 0x00000002u;
  return feed_version_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* FeedHeader::release_feed_version() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return feed_version_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void FeedHeader::set_allocated_feed_version(std::string* feed_version) {
  ...
  feed_version_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), feed_version,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:transit_realtime.FeedHeader.feed_version)
}
inline std::string* FeedHeader::unsafe_arena_release_feed_version() {
  // @@protoc_insertion_point(field_unsafe_arena_release:transit_realtime.FeedHeader.feed_version)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return feed_version_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void FeedHeader::unsafe_arena_set_allocated_feed_version(
    std::string* feed_version) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (feed_version != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  feed_version_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      feed_version, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:transit_realtime.FeedHeader.feed_version)
}
...
inline void TripDescriptor_ModifiedTripSelector::set_start_time(const std::string& value) {
  _internal_set_start_time(value);
...
inline void TripDescriptor_ModifiedTripSelector::set_start_time(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  start_time_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:transit_realtime.TripDescriptor.ModifiedTripSelector.start_time)
}
inline void TripDescriptor_ModifiedTripSelector::set_start_time(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  start_time_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:transit_realtime.TripDescriptor.ModifiedTripSelector.start_time)
}
inline void TripDescriptor_ModifiedTripSelector::set_start_time(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  start_time_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:transit_realtime.TripDescriptor.ModifiedTripSelector.start_time)
}
...
inline std::string* TripDescriptor_ModifiedTripSelector::unsafe_arena_release_start_time() {
  // @@protoc_insertion_point(field_unsafe_arena_release:transit_realtime.TripDescriptor.ModifiedTripSelector.start_time)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
  return start_time_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TripDescriptor_ModifiedTripSelector::unsafe_arena_set_allocated_start_time(
    std::string* start_time) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (start_time != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  ...
  start_time_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      start_time, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:transit_realtime.TripDescriptor.ModifiedTripSelector.start_time)
}
...
inline void TripDescriptor_ModifiedTripSelector::set_start_date(const std::string& value) {
  _internal_set_start_date(value);
...
inline void TripDescriptor_ModifiedTripSelector::set_start_date(std::string&& value) {
  _has_bits_[0] |= 0x00000008u;
  start_date_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:transit_realtime.TripDescriptor.ModifiedTripSelector.start_date)
}
inline void TripDescriptor_ModifiedTripSelector::set_start_date(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  start_date_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:transit_realtime.TripDescriptor.ModifiedTripSelector.start_date)
}
inline void TripDescriptor_ModifiedTripSelector::set_start_date(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  start_date_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:transit_realtime.TripDescriptor.ModifiedTripSelector.start_date)
}
...
inline std::string* TripDescriptor_ModifiedTripSelector::unsafe_arena_release_start_date() {
  // @@protoc_insertion_point(field_unsafe_arena_release:transit_realtime.TripDescriptor.ModifiedTripSelector.start_date)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000008u;
  return start_date_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TripDescriptor_ModifiedTripSelector::unsafe_arena_set_allocated_start_date(
    std::string* start_date) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (start_date != nullptr) {
    _has_bits_[0] |= 0x00000008u;
  ...
  start_date_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      start_date, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:transit_realtime.TripDescriptor.ModifiedTripSelector.start_date)
}
